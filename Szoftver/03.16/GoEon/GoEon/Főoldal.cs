...
namespace GoEon
{
    public partial class Fooldal : Form
    {
        ...
        private void automatikus_hozzarendeles_button_Click(object sender, EventArgs e)
        {
            ...
            feladatok.Clear();
            db.Read_Task(feladatok);
            Automatikus_hozzarendeles_kezeles uj_form = new Automatikus_hozzarendeles_kezeles(remove_previosly_added_task(teams_help), feladatok);
            uj_form.Show();
        }

        //Kitörli azokat a feladatokat a csapatok dictionary-ból, amik ár hozzá lettek rendelve másik csapathoz
        List<Team> remove_previosly_added_task(List<Team> teams_help)
        {
        ...
        {
            Elvegzett_feladatok_megadasa uj_form = new Elvegzett_feladatok_megadasa();
            uj_form.Show();
        }
    }
}
