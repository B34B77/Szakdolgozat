    ...
    class Database_Manager
    {
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    lista.Add(new Feladatok(rdr.GetInt32(0), rdr.GetString(1), rdr.GetString(2),
                        rdr.GetString(3), rdr.GetInt32(4), rdr.GetString(5), rdr.GetString(6), rdr.GetString(7), rdr.GetString(8), rdr.GetString(9), rdr.GetString(10), rdr.GetString(11), rdr.GetString(12)));
                }
            }
        ...
        public void doneTask(string taskName, string date, string team)
        {
            ...
            try
            {
                ...
                string stm = "UPDATE task_table SET done = "- WHERE task_name =" + taskName + "; ";
                MySqlCommand cmd = new MySqlCommand(stm, conn);
                cmd.ExecuteNonQuery();
            }
            catch (MySqlException ex)
