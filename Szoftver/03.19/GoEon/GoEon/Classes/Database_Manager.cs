...
namespace GoEon
{
    class Database_Manager
    {
            ...
            try
            {
                ...
                while (rdr.Read())
                {
                    lista.Add(new Feladatok(rdr.GetInt32(0), rdr.GetString(1), rdr.GetString(2),
                        rdr.GetString(3), rdr.GetInt32(4), rdr.GetString(5), rdr.GetString(6), rdr.GetString(7), rdr.GetString(8), rdr.GetString(9), rdr.GetString(10), rdr.GetString(11), rdr.GetString(12), rdr.GetString(13)));
                }
            }
        ...
        public void Read_Team(List<Team> lista)
        {
            conn = null;
            rdr = null;
        ...
        public void clear_task_management_table()
        {
            conn = null;
            rdr = null;
            ...
            try
            {
                ...
                string stm = "DELETE FROM task_management_table WHERE id > 0; alter table task_management_table auto_increment = 1; ";
                MySqlCommand cmd = new MySqlCommand(stm, conn);
                cmd.ExecuteNonQuery();
            }
            catch (MySqlException ex)
            {
                ...
                string messageBoxText = "Hiba történt az adatbázisból való törlés során:" + ex;
                string caption = "Adatbázis kezelés hiba";
                DialogResult warning = MessageBox.Show(messageBoxText, caption, MessageBoxButtons.OK);
        ...
        //Az datbázisban a feladatok táblában feltölti értékkel a tábla done mezőjét, jelezve ezzel, hogy a feladat már elvégzésre került
        public void doneTask(string taskName, string date, string team)
        {
            ...
            {               
                ...
                MySqlCommand cmd = new MySqlCommand();
                cmd.Connection = conn;
                cmd.CommandText = "UPDATE task_table SET done = @data WHERE task_name = @taskName;";
                cmd.Prepare();

                cmd.Parameters.AddWithValue("@data", team + " (" + date + ")" );
