...
namespace GoEon
{
    public partial class Fooldal : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            calendar_desc_panel_red.BackColor = Color.Red;
        ...
        {
            Csapat_hozzarendeles uj = new Csapat_hozzarendeles(feladatok, csapatok, "Összes");
            uj.Show();
